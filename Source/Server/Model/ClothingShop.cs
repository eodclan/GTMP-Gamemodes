...
namespace FactionLife.Server.Model
{
	class ClothingShop
	{
        ...
        public ClothingShop()
		{
            ...
            AvailableTorso = new List<Clothing>();
            AvailableUndershirt = new List<Clothing>();
            AvailableDecals = new List<Clothing>();
            AvailableHair = new List<Clothing>();
            AvailableBackpacks = new List<Clothing>();
