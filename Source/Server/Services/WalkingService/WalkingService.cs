...
namespace FactionLife.Server.Services.WalkingService
{
    ...
    public class Main : Script
    {
        List<WalkingStyle> WalkingStyles = new List<WalkingStyle>
        {
            ...
            new WalkingStyle("Mutig", "move_m@brave"),
            new WalkingStyle("Zuversichtlich", "move_m@confident"),
            new WalkingStyle("Betrunken", "move_m@drunk@verydrunk"),
            new WalkingStyle("Fett", "move_m@fat@a"),
            new WalkingStyle("Gangster", "move_m@shadyped@a"),
            new WalkingStyle("Eile", "move_m@hurry@a"),
            new WalkingStyle("Verletzt", "move_m@injured"),
            new WalkingStyle("Eingeschüchtert", "move_m@intimidation@1h"),
            new WalkingStyle("Schnell", "move_m@quick"),
            new WalkingStyle("Traurig", "move_m@sad@a"),
            new WalkingStyle("Harter Typ", "move_m@tool_belt@a")
        };
