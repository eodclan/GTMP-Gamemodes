...
using FactionLife.Server.Services.HelperService;

namespace FactionLife.Server.Services.RoleplayService
{
    [Flags]
        ...
        private void Actions_onClientEventTrigger(Client player, string eventName, params object[] args)
        {
            switch (eventName)
            {
                ...
                case "SetAction":
                    ...
                    API.sendNotificationToPlayer(player, "<C>Animation:</C> ~r~Benutze nun die Caps Lock Taste.");
        ...
        public void genactions(Client sender)
        {
            ...
            foreach (var emotionName in emotions_names)
            {
                ...
                ActionsGen.Add(new Action(
                    emotionName,
                    new Animation(UpperDictionary, "enter", HelperService.Helper.GetAnimationTimeFromPlayer(sender, UpperDictionary, "enter")),
                    new Animation(UpperDictionary, "idle_a", HelperService.Helper.GetAnimationTimeFromPlayer(sender, UpperDictionary, "idle_a")),
                    new Animation(UpperDictionary, "exit", HelperService.Helper.GetAnimationTimeFromPlayer(sender, UpperDictionary, "exit")),
                    new Animation(FemaleCelebDctionary, emotionName, HelperService.Helper.GetAnimationTimeFromPlayer(sender, FemaleCelebDctionary, emotionName)),
                    new Animation(MaleCelebDctionary, emotionName, HelperService.Helper.GetAnimationTimeFromPlayer(sender, MaleCelebDctionary, emotionName))
                ));
            }
