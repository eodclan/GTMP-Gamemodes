...
{
    class OrangenService10 : Script
    {
        public OrangenService10()
        {
        ...
        public void OnStart()
        {
            misStartColshape = API.createCylinderColShape(new Vector3(-1767.832, 2028.991, 122.6916), 3F, 2F); // colshap for mission start point
        ...
        public void OnClientEvent(Client client, string eventName, params object[] arguments)
        {
            ...
            switch (eventName)
            {
                case "KeyboardKey_E_Pressed":
                    ...
                    if (IsInRangeOf(client.position, new Vector3(-1767.832, 2028.991, 122.6916), 2f))
                    {
