...
{
    class OrangenService13 : Script
    {
        public OrangenService13()
        {
        ...
        public void OnStart()
        {
            ...
            misStartColshape = API.createCylinderColShape(new Vector3(-1776.46, 2030.929, 124.5926), 3F, 2F); // colshap for mission start point
        ...
        public void OnClientEvent(Client client, string eventName, params object[] arguments)
        {
            ...
            switch (eventName)
            {
                case "KeyboardKey_E_Pressed":
                    ...
                    if (IsInRangeOf(client.position, new Vector3(-1776.46, 2030.929, 124.5926), 2f))
                    {
