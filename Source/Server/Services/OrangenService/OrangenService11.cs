...
{
    class OrangenService11 : Script
    {
        public OrangenService11()
        {
        ...
        public void OnStart()
        {
            misStartColshape = API.createCylinderColShape(new Vector3(-1761.271, 2017.726, 120.4014), 3F, 2F); // colshap for mission start point
        ...
        public void OnClientEvent(Client client, string eventName, params object[] arguments)
        {
            ...
            switch (eventName)
            {
                case "KeyboardKey_E_Pressed":
                    if (IsInRangeOf(client.position, new Vector3(-1761.271, 2017.726, 120.4014), 2f))
                    {
