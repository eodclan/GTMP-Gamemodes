...
namespace FactionLife.Server.Services.BlipService
{
        ...
        : Script
	{
        ...
        public static void ReloadCustomBlipsFromDatabase()
        {
            BlipList.ForEach(blip =>
            {
                if (blip != null)
		...
		public static void LoadCustomBlipsFromDatabase()
		{
		    ...
		    if (result.Rows.Count != 0)
		    {
		        ...
		        API.shared.consoleOutput(LogCat.Info, result.Rows.Count + " Benutzerdefinierte Blips geladen..");
		    }
		    else
		    {
		        API.shared.consoleOutput(LogCat.Info, "Keine benutzerdefinierten Blips geladen..");
		    }
		}
