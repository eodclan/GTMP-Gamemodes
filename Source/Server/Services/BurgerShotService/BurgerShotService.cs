...
namespace FactionLife.Server.Services.BurgerShotService
{
        ...
        : Script
    {
        ...
        public static void LoadBurgerShotFromDB()
        {
            ...
            if (result.Rows.Count != 0)
            {
                foreach (DataRow row in result.Rows)
                {
                    ...
                    BurgerShot.Blip.sprite = 106;
                    BurgerShot.Blip.name = "Burger Shot";
                    BurgerShot.Blip.color = 75;
                    ...
                    //API.createMarker(1, new Vector3(-1183.21, -884.242, 13.7455), new Vector3(), new Vector3(), new Vector3(1f, 1f, 1f), 255, 255, 0, 0);
            ...
            {
                API.shared.consoleOutput(LogCat.Info, "Keine BurgerShot geladen ..");
            }
        }
        ...
        public static BurgerShot AddBurgerShot(Vector3 position)
        {
            ...
            BurgerShot.Blip.sprite = 501;
            BurgerShot.Blip.scale = 0.8f;
        ...
        public static void RefreshBurgerShotBuyMenu(Client client, BurgerShot BurgerShot)
        {
            List<BurgerShotMenuItem> BurgerShotItems = new List<BurgerShotMenuItem>();
            BurgerShot.Storage.ForEach(item =>
            {
