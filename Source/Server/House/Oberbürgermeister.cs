...
{
    public class Staatschef : Script
    {
        public Staatschef()
        {
        ...
        public void onResourceStart()
        {
            ...
            Blip Staatschef = API.createBlip(new Vector3(-917.0534f, 10.32921f, 47.04765f));
            API.setBlipSprite(Staatschef, 350);
            API.setBlipColor(Staatschef, 4);
            API.setBlipScale(Staatschef, 0.7f);
        }       
    } 
