...
namespace FactionLife.Server.Services.FactionService
{
    public class Haus1 : Script
    {
        ...
        public void onResourceStart()
        {
            ...
            Blip Haus1 = API.createBlip(new Vector3(-1039.361f, 316.1132f, 66.8809f));
            API.setBlipSprite(Haus1, 350);
            API.setBlipColor(Haus1, 4);
            API.setBlipScale(Haus1, 0.7f);
        }       
    } 
