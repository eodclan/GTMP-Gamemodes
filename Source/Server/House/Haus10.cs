...
namespace FactionLife.Server.Services.FactionService
{
    public class Haus10 : Script
    {
        ...
        public void onResourceStart()
        {
            ...
            Blip Haus10 = API.createBlip(new Vector3(165.4231f, -1860.692f, 23.70089f));
            API.setBlipSprite(Haus10, 350);
            API.setBlipColor(Haus10, 4);
            API.setBlipScale(Haus10, 0.7f);
        }       
    } 
