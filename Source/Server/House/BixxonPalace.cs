...
namespace FactionLife.Server.Services.FactionService
{
    public class Richman : Script
    {
        ...
        public void onResourceStart()
        {
            ...
            Blip Richman = API.createBlip(new Vector3(-658.692f, 906.5909f, 228.4987f));
            API.setBlipSprite(Richman, 350);
            API.setBlipColor(Richman, 4);
            API.setBlipScale(Richman, 0.7f);
        }       
    } 
