...
namespace FactionLife.Server.Services.FactionService
{
    public class Haus12 : Script
    {
        ...
        public void onResourceStart()
        {
            ...
            Blip Haus12 = API.createBlip(new Vector3(149.8171f, -1865.932f, 24.21368f));
            API.setBlipSprite(Haus12, 350);
            API.setBlipColor(Haus12, 4);
            API.setBlipScale(Haus12, 0.7f);
        }       
    } 
