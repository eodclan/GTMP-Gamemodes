...
namespace FactionLife.Server.Services.FactionService
{
    public class Haus13 : Script
    {
        ...
        public void onResourceStart()
        {
            ...
            Blip Haus13 = API.createBlip(new Vector3(129.1688f, -1854.21f, 24.90163f));
            API.setBlipSprite(Haus13, 350);
            API.setBlipColor(Haus13, 4);
            API.setBlipScale(Haus13, 0.7f);
        }       
    } 
