...
var CharCreatorMenu = API.createMenu("Character Erstellen", "", 0, 0, 6);
...
var first_name_item = API.createMenuItem("Vorname", "");
var last_name_item = API.createMenuItem("Nachname", "");
var gender_selector = API.createListItem("Geschlecht", "", gender_list, 0);
var char_save_button = API.createMenuItem("Character Speichern", "");
