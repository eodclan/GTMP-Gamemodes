...
var ClothingItemTops = API.createListItem("Oberteile", "", listtops, 0);
var ClothingItemTexture = API.createListItem("Oberteil Farbe", "", listtexture, 0);
...
var ClothingItemSave = API.createMenuItem("~g~Speichern", "");
var ClothingItemClose = API.createMenuItem("~r~Schliessen", "");
