"use strict";
var GasStationMenu = API.createMenu("Tankstelle", "Wählen Sie Kraftstofftyp:", 0, 0, 6);
var GasStationVehicleMenu = API.createMenu("Tankstelle", "Wählen Sie Fahrzeug zum Auftanken:", 0, 0, 6);
var GasStationJson;
...
function GasStationFillMenu() {
    ...
    for (var i = 0; i < GasStationJson.length; i++) {
        ...
        if (gasStationObj["SoldOut"]) {
            NewItem.SetRightLabel("~r~Ausverkauft");
        }
        else {
