...
var ATM_WithdrawItem = API.createMenuItem("~b~Abheben", "");
var ATM_DepositItem = API.createMenuItem("~g~Einzahlen", "");
var ATM_Amount = "0";
    ...
    switch (item) {
        case ATM_AmountItem:
            ...
            if (ATMisValid) {
                ...
                API.sendNotification("~r~Fehler~w~: Bitte geben Sie eine gültige Nummer ein");
                ATM_Amount = "0";
                ATM_AmountItem.SetRightLabel(ATM_Amount + ".00 ~g~$");
            }
            break;
