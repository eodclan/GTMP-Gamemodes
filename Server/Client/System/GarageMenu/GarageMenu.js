...
var ParkOutItem = API.createMenuItem("Fahrzeug ausparken", "");
var ParkItem = API.createMenuItem("Fahrzeug einparken", "");
GarageMenu.AddItem(ParkOutItem);
GarageMenu.AddItem(ParkItem);
var GarageSubMenu = API.createMenu("Ihre Fahrzeuge", "Verfügbare Fahrzeuge:", 0, 0, 6);
